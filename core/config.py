...
class Settings:
    ...
    soft_stop_confirm_sec: float = _f("SOFT_STOP_CONFIRM_SEC", 6.0)
    soft_stop_confirm_buffer_pct: float = _f("SOFT_STOP_CONFIRM_BUFFER_PCT", 0.03)
    soft_stop_adverse_velocity: float = _f("SOFT_STOP_ADVERSE_VELOCITY", 0.0003)
