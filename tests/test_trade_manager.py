...
def main():
    ...
    cases = [
        ...
        ("stop_loss_blocks_same_market_reentry_even_with_residual", should_block_same_market_reentry("stop-loss", remaining_shares=0.02) is True),
        ("residual_force_close_blocks_same_market_reentry", should_block_same_market_reentry("residual-force-close", remaining_shares=0.25) is True),
